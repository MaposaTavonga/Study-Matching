...
export default function TutorLandingScreen() {
  ...
  // Dummy data
  const requests = [
    { id: 1, student: 'Sarah M', module: 'MAT101 - Calculus I', time: 'Wed, 4:00 PM', avatarColor: '#FF6B6B', urgency: 'high' },
    { id: 2, student: 'John D', module: 'PHYS101 - Mechanics', time: 'Fri, 2:00 PM', avatarColor: '#4ECDC4', urgency: 'medium' },
    { id: 3, student: 'Alex T', module: 'CHEM101 - Organic Chemistry', time: 'Today, 6:00 PM', avatarColor: '#FFD166', urgency: 'high' },
  ];

  const upcomingSessions = [
    { id: 1, module: 'MAT101 - Calculus I', date: 'Mon, 3:00 PM', students: 5, duration: '2 hours', type: 'Group Session' },
    { id: 2, module: 'PHYS101 - Mechanics', date: 'Thu, 1:00 PM', students: 3, duration: '1.5 hours', type: 'One-on-One' },
    { id: 3, module: 'MAT201 - Calculus II', date: 'Tomorrow, 10:00 AM', students: 8, duration: '2 hours', type: 'Group Session' },
  ];

  const quickStats = { totalStudents: 42, sessionsThisWeek: 8, pendingRequests: 3 };
  ...
  // Calculate header top padding based on platform
  const getHeaderTopPadding = () => {
    if (Platform.OS === 'ios') {
      return 50; // For iOS notch
    }
    return 20; // For Android and other platforms
  };
  ...
  const QuickActions = () => (
    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 24 }}>
      ...
      >
        ...
        <Text style={{ color: '#fff', fontWeight: '600', fontSize: 15 }}>New Session</Text>
      </TouchableOpacity>
      ...
      >
        ...
        <Text style={{ color: '#4F46E5', fontWeight: '600', fontSize: 15 }}>Set Availability</Text>
      </TouchableOpacity>
    </View>
  );
  ...
  const StudentRequests = () => (
    <View style={{ marginBottom: 24 }}>
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
        <Text style={{ fontSize: 18, fontWeight: '700', color: '#1F2937' }}>Student Requests</Text>
        ...
        <View key={r.id} style={{
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
            <View style={{
              ...
              <Text style={{ color: '#fff', fontWeight: '600', fontSize: 16 }}>{r.student.charAt(0)}</Text>
            </View>
            <View style={{ flex: 1 }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 8 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 8 }}>
              <TouchableOpacity style={{ backgroundColor: '#10B981', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10, minWidth: 80, alignItems: 'center' }}>
                <Text style={{ color: '#fff', fontSize: 14, fontWeight: '600' }}>Accept</Text>
              </TouchableOpacity>
              <TouchableOpacity style={{ backgroundColor: '#F3F4F6', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 10, minWidth: 80, alignItems: 'center' }}>
  ...
  const UpcomingSessions = () => (
    <View style={{ marginBottom: 24 }}>
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
        <Text style={{ fontSize: 18, fontWeight: '700', color: '#1F2937' }}>Upcoming Sessions</Text>
  ...
  const QuickLinks = () => (
    <View style={{ marginBottom: 24, flexDirection: 'row', flexWrap: 'wrap', gap: 12, justifyContent: 'space-between' }}>
      {quickLinks.map((item, index) => (
        ...
        >
          ...
          <Text style={{ color: '#1F2937', fontWeight: '600', fontSize: 14 }}>{item.title}</Text>
          {item.badge && (
            <View style={{
              position: 'absolute',
              top: 12,
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#F8FAFC' }}>
      ...
      <View style={{
        ...
        paddingTop: getHeaderTopPadding(), // Dynamic padding
        paddingBottom: 18,
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <View>
            ...
            <Text style={{ color: '#fff', fontSize: 22, fontWeight: '700', marginTop: 2 }}>Dr. Emily Carter</Text>
            <Text style={{ color: '#E0E7FF', fontSize: 13, fontWeight: '400', marginTop: 4 }}>Mathematics & Physics Tutor</Text>
          </View>
          <TouchableOpacity
            style={{
              width: 48,
